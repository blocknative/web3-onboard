...
const Mew = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<h1>@web3-onboard/mew</h1>
<p>Wallet module for connecting Mew wallet to web3-onboard</p>
      ...
      return `${validate_component(TabPanel, "TabPanel").$$render($$result, { value: "yarn" }, {}, {
        default: () => {
          return `${validate_component(CodeFence, "CodeFence").$$render($$result, {
            ...
            ext: "sh",
            linesCount: 2,
            rawCode: "yarn add @web3-onboard/mew\n",
            showCopyCode: true,
            code: '<pre><code><span class="line"><span style="color: #A6ACCD">yarn add @web3-onboard/mew</span></span>\n<span class="line"></span></code></pre>'
          }, {}, {})}`;
        }
      })}
  ${validate_component(TabPanel, "TabPanel").$$render($$result, { value: "npm" }, {}, {
        default: () => {
          return `${validate_component(CodeFence, "CodeFence").$$render($$result, {
            ...
            ext: "sh",
            linesCount: 2,
            rawCode: "npm install @web3-onboard/mew\n",
            showCopyCode: true,
            code: '<pre><code><span class="line"><span style="color: #A6ACCD">npm install @web3-onboard/mew</span></span>\n<span class="line"></span></code></pre>'
          }, {}, {})}`;
        }
      })}`;
    }
...
${validate_component(CodeFence, "CodeFence").$$render($$result, {
    ...
    default: () => {
      return `<p>Currently not building on M1 Macs</p>`;
    }
  })}`;
});
export { Mew as default };
