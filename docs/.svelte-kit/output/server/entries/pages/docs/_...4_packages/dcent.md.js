...
const Dcent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<h1>@web3-onboard/dcent</h1>
<h2 id="${"wallet-module-for-connecting-d-cent-hardware-wallets-to-web3-onboard"}" tabindex="${"-1"}">${validate_component(Link, "Link").$$render($$result, {
    class: "header-anchor",
    href: "#wallet-module-for-connecting-d-cent-hardware-wallets-to-web3-onboard",
    "aria-hidden": "true"
  }, {}, {
    default: () => {
      return `#`;
    }
  })} Wallet module for connecting D&#39;CENT hardware wallets to web3-onboard</h2>
      ...
      return `${validate_component(TabPanel, "TabPanel").$$render($$result, { value: "yarn" }, {}, {
        default: () => {
          return `${validate_component(CodeFence, "CodeFence").$$render($$result, {
            ...
            ext: "sh",
            linesCount: 2,
            rawCode: "yarn add @web3-onboard/dcent\n",
            showCopyCode: true,
            code: '<pre><code><span class="line"><span style="color: #A6ACCD">yarn add @web3-onboard/dcent</span></span>\n<span class="line"></span></code></pre>'
          }, {}, {})}`;
        }
      })}
  ${validate_component(TabPanel, "TabPanel").$$render($$result, { value: "npm" }, {}, {
        default: () => {
          return `${validate_component(CodeFence, "CodeFence").$$render($$result, {
            ...
            ext: "sh",
            linesCount: 2,
            rawCode: "npm install @web3-onboard/dcent\n",
            showCopyCode: true,
            code: '<pre><code><span class="line"><span style="color: #A6ACCD">npm install @web3-onboard/dcent</span></span>\n<span class="line"></span></code></pre>'
          }, {}, {})}`;
        }
      })}`;
    }
