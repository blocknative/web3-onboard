...
const Web3auth = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<h1>@web3-onboard/web3auth</h1>
<p>Wallet module for connecting Web3auth to web3-onboard</p>
      ...
      return `${validate_component(TabPanel, "TabPanel").$$render($$result, { value: "yarn" }, {}, {
        default: () => {
          return `${validate_component(CodeFence, "CodeFence").$$render($$result, {
            ...
            ext: "sh",
            linesCount: 2,
            rawCode: "yarn add @web3-onboard/web3auth\n",
            showCopyCode: true,
            code: '<pre><code><span class="line"><span style="color: #A6ACCD">yarn add @web3-onboard/web3auth</span></span>\n<span class="line"></span></code></pre>'
          }, {}, {})}`;
        }
      })}
  ${validate_component(TabPanel, "TabPanel").$$render($$result, { value: "npm" }, {}, {
        default: () => {
          return `${validate_component(CodeFence, "CodeFence").$$render($$result, {
            ...
            ext: "sh",
            linesCount: 2,
            rawCode: "npm install @web3-onboard/web3auth\n",
            showCopyCode: true,
            code: '<pre><code><span class="line"><span style="color: #A6ACCD">npm install @web3-onboard/web3auth</span></span>\n<span class="line"></span></code></pre>'
          }, {}, {})}`;
        }
      })}`;
    }
...
<p>See the ${validate_component(Link, "Link").$$render($$result, {
    href: "https://docs.web3auth.io/api-reference/web/plugnplay",
    target: "_blank",
    rel: "noopener noreferrer"
  }, {}, {
    default: () => {
      return `Web3auth Docs`;
    }
