...
For example with onboard.js, if you wanted to support only Metamask and Coinbase in your app, you had to install onboard.js complete with all other wallets: `npm install bnc-onboard`.
